...
class Usuario(models.Model):
	...
	def isOk(self):
		...
		if not bool (self.password) or self.password.isspace():
			ok += "La contraseña está vacía\n"
		#El nombre no puede tener números ni estar vacío
		if any(char.isdigit() for char in self.nombre) or self.nombre.isspace():
			ok += "Nombre con dígitos o vacío\n"
