...
class GuestBookViewsTestCase(django.test.TestCase):
    ...
    def testGrupo(self):
        ...
        Grupo.objects.create(nombre = "test1", descripcion = "asdasd", organizacion = organizacionTest, administrador = usuarioTest)
        Grupo.objects.create(nombre = "", descripcion = "test2", organizacion = organizacionTest, administrador = usuarioTest)
        Grupo.objects.create(nombre = "test3", descripcion = "", organizacion = organizacionTest, administrador = usuarioTest)
